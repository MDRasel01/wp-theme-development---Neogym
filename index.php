...
<head>
  ...
  <!-- slider stylesheet -->
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()."/assets/https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css";?>" />

  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri()."/assets/css/bootstrap.css";?>" />

  <!-- fonts style -->
  <link href="<?php echo get_template_directory_uri()."/assets/https://fonts.googleapis.com/css?family=Poppins:400,600,700&display=swap";?>" rel="stylesheet">
